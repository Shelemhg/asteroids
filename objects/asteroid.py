...
from constants import BIG_ROCK_TEXTURE, BIG_ROCK_SPEED, BIG_ROCK_SPIN, BIG_ROCK_RADIUS, MEDIUM_ROCK_TEXTURE, MEDIUM_ROCK_SPEED, MEDIUM_ROCK_SPIN, MEDIUM_ROCK_RADIUS, SMALL_ROCK_TEXTURE, SMALL_ROCK_SPEED, SMALL_ROCK_SPIN, SMALL_ROCK_RADIUS, SCREEN_WIDTH, SCREEN_HEIGHT
